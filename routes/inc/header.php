...
<div class="phpcoding">
	<section class="headeroption">
		<h2><?php echo "Voting System- Admin"; ?></h2>
	</section>
	<!-- <button href="logout.php">logout</button> -->
	<a href="logout.php" style="float:right; border:solid black 1px; border-radius:2px; background-color:red;">Logout</a>
